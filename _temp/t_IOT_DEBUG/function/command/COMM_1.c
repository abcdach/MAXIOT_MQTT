...
//#------------------------------------------------------------------------
	if (JSON_STATUS == 1){
			...
			if(SLOT_INDEX != -1){
				sprintf(data,"{\"COMM\":\"1\",\"INDEX\":\"%ld\",\"d0\":\"%ld\",\"d1\":\"%ld\",\"d2\":\"%ld\",\"d3\":\"%ld\",\"d4\":\"%ld\",\"d5\":\"%ld\",\"d6\":\"%s\"}"
						, INDEX
						, DEVICE_NAME
						, SLOT_INDEX
						...
						, SYS_API__GET__DEVICE_DESCRIPTION_By_SLOT_INDEX(SLOT_INDEX));
			//printf("WebSo(%d)>> %s\n\r",sock,data);
			} else {
				sprintf(data,"{\"COMM\":\"1\",\"INDEX\":\"%ld\",\"d0\":\"%ld\",\"d1\":\"%ld\",\"d2\":\"%ld\",\"d3\":\"%ld\",\"d4\":\"%ld\",\"d5\":\"%ld\",\"d6\":\"%ld\"}"
						, INDEX
						, (long)-1
						, (long)-1
						, (long)-1
