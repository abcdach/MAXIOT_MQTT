...
static void test_encrypt_ecb_verbose(void)
{
    ...
    uint8_t key[16] = {'F','A','3','7','6','E','3','8','3','6','2','6','4','9','1','F'};
    // 512bit text
...
//b94ce041143b01baf5f841913d541952
//FA376E383626491F B6F3B6B5C06B1C20
//0123456789ABCDEF
//###############################################
static void test_decrypt_cbc(void)
{
	...
	sprintf(Temp,"FA376E383626491F");
	for (i = 0; i < 16; ++i)key[i]=Temp[i];
	sprintf(Temp,"TextMustBe16Byte");
	for (i = 0; i < 16; ++i)in[i]=Temp[i];
	sprintf(Temp,"0123456789ABCDEF");
	for (i = 0; i < 16; ++i)iv[i]=Temp[i];
